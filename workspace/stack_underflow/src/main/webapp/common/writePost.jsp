...
<html>
	...
	<body>
		...
		<h2>게시판 글쓰기</h2>
		<form action="" name = "writePost" method = "post" onsubmit = "return validateForm(this)">
			<!--
			...
			<table border = "1" width = "90%">
				...
				<tr>
					<td colspan = "2" align = "center">
						...
						<button type = "button" onclick = "location.href = 목록 보여주는 jsp파일">목록 보기</button>
						<input type = "button" onclick = "test()" value = "shit">
					</td>
				</tr>
			</table>
