...
<!DOCTYPE html>
	...
	<!-- 
		...
		Jack Snider 02 ==> 우측 상단 Sign up 버튼
		Jack Snider 03 ==> 화면 중앙 로그인 버튼
		Jack Snider 04 ==> 아이디 입력란
		Jack Snider 05 ==> 비밀번호 입력란 
		Jack Snider 06 ==> 로고
...
your communities            </h3>
        ...
        <div class="modal-content" id="your-communities-section">
        	...
        	<div class="call-to-login">
				<a href="signup.jsp" class="login-link js-gps-track" data-gps-track="site_switcher.click({ item_type:10 })">Sign up</a> or <a href="https://stackoverflow.com/users/login?ssrc=site_switcher" class="login-link js-gps-track" data-gps-track="site_switcher.click({ item_type:11 })">log in</a> to customize your list.                </div>
        	</div>
        	<!-- Jack Snider 02 ends -->
        ...
        <div class="modal-content">
            ...
            <li><a href="#" class="s-topbar--item s-btn s-btn__icon s-btn__muted d-none sm:d-inline-flex js-searchbar-trigger" role="button" aria-label="Search" aria-haspopup="true" aria-controls="search" title="Click to show search"><svg aria-hidden="true" class="svg-icon iconSearch" width="18" height="18" viewBox="0 0 18 18"><path d="m18 16.5-5.14-5.18h-.35a7 7 0 1 0-1.19 1.19v.35L16.5 18l1.5-1.5ZM12 7A5 5 0 1 1 2 7a5 5 0 0 1 10 0Z"/></svg></a></li>
            	...
            	<li>
            		<!-- Jack Snider 06 begins -->
            		<a href="signup.jsp" class="s-topbar--item s-topbar--item__unset ml4 s-btn s-btn__primary ws-nowrap" rel="nofollow" data-ga="[&quot;sign up&quot;,&quot;Sign Up Navigation&quot;,&quot;Header&quot;,null,null]">Sign up</a>
            		<!-- Jack Snider 06 ends -->
            	</li>
</ol>
...
<div id="formContainer" class="mx-auto mb24 p24 wmx3 bg-white bar-lg bs-xl mb24">
    <form id="login-form" class="d-flex fd-column gs12 gsy" action="/users/login?ssrc=head&returnurl=https%3a%2f%2fstackoverflow.com%2f" method="POST">
        <input type="hidden" name="fkey" value="f8a6dc1dd33a9522b7177f9b9127a90de52ef6d89c73cb58505079e03ab6ea75">
            <input type="hidden" name="ssrc" value="head" />
                <div class="d-flex fd-column gs4 gsy js-auth-item ">
                    <label class="flex--item s-label" for="id">ID</label>
                    <div class="d-flex ps-relative">
                    	<!-- Jack Snider 04 begins -->
...
(function(i, s, o, g, r, a, m) {
            ...
            StackExchange.ready(function () {
                ...
                StackExchange.ga.setDimension('dimension7', "1660099773.655362595");
