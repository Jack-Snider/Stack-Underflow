...
<!DOCTYPE html>
    ...
    <script defer src="https://cdn.sstatic.net/Js/product/animations.en.js?v=158f5b78e6f4"></script>
    <script defer src="https://cdn.sstatic.net/Js/product/lazy-load-images.en.js?v=bf756d69cd54"></script>
  ...
  //useCaseInit();
        ...
        <div class="site-footer--container">
            ...
            <div class="site-footer--copyright fs-fine md:mt24">
                ...
                <p class="md:mb0">
Site design / logo &#169; 2022 Stack Exchange Inc; user contributions licensed under <span class='td-underline'><a href="https://stackoverflow.com/help/licensing">CC BY-SA</a></span>.                    <span id="svnrev">rev&nbsp;2022.8.8.42758</span>
                </p>
            </div>
        </div>
...
(function(i, s, o, g, r, a, m) {
            ...
            StackExchange.ready(function () {
                ...
                StackExchange.ga.setDimension('dimension7', "1660032222.1611014868");
