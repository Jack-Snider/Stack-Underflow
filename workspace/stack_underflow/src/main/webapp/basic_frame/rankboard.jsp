   ...
   <!-- 왼쪽 div  -->
    <div class="col-sm-2" style="background-color:white; ">
       ...
       <i class="fa-solid fa-avocado"></i>
        <ul id="categoryul">
          <li><i class="fa-solid fa-trophy" style="color : gold"></i>1위</li>
          <li><i class="fa-solid fa-award" style="color : silver"></i>2위</li>
          <li><i class="fa-solid fa-medal" style="color : brown"></i>3위</li>
        </ul>
       </div>   
...
<br><br><br><br><br><br><i class="bi bi-trophy-fill"></i>
