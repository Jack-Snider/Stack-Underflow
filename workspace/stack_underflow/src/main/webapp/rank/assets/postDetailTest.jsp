...
<!-- 호겸 끝 -->
	...
	<%-- 				<button class = "updateCmnt btn btn-outline-success" type = "button" value = <%= cmnt.getCmnt_num() %>>수정</button> 
					<button class = "deleteCmnt btn btn-outline-success" type = "button" value = <%= cmnt.getCmnt_num() %>>삭제</button> --%>
					<hr>
